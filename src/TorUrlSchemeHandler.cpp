...
void TorUrlSchemeHandler::requestStarted(QWebEngineUrlRequestJob *job)
{
...
void TorUrlSchemeHandler::onTimerEvent()
{
BEGIN_SLOT_WRAPPER
...
*/
void TorUrlSchemeHandler::removeOnRequestId(const std::string &requestId)
{
