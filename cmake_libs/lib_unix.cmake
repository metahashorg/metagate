function(add_common_options_internal TARGET CURR_PATH)
    ...
    target_include_directories(${TARGET} PUBLIC ${CURR_PATH}/../3rdparty/openssl_linux/include/)
    ...
    find_library(SSL_LIBRARY NAMES ssl HINTS ${CURR_PATH}/../3rdparty/openssl_linux/lib)
    find_library(CRYPTO_LIBRARY NAMES crypto HINTS ${CURR_PATH}/../3rdparty/openssl_linux/lib)
    find_library(CRYPTOPP_LIBRARY NAMES cryptopp HINTS ${CURR_PATH}/../3rdparty/cryptopp/lib/linux/)
    find_library(QUAZIP_LIBRARY NAMES quazip HINTS ${CURR_PATH}/../3rdparty/quazip-0.7.3/libs/linux/)
    find_library(SECP_LIBRARY NAMES secp256k1 HINTS ${CURR_PATH}/../3rdparty/secp256k1/lib/linux/)
