function(add_common_options_internal TARGET CURR_PATH)
    set_target_properties(${TARGET} PROPERTIES LINK_FLAGS "-Wl,-rpath,@loader_path/../,-rpath,@executable_path/../,-rpath,@executable_path/../Frameworks")
    ...
    target_include_directories(${TARGET} PUBLIC ${CURR_PATH}/../3rdparty/)
    ...
    find_library(SECP_LIBRARY NAMES secp256k1 HINTS ${CURR_PATH}/../3rdparty/secp256k1/lib/macx/)
